...
public class SynchronizeWizardSectionViewModel : ViewModelBase
{
    public SynchronizeWizardSectionViewModel(IEnumerable<IPlugin> plugins, INotificationService notificationService, Maybe<ILogger> logger)
    {
